...
//		if( ch4.irq_enable ) data |= 0x80; // Syncで実装してある
	}
...
//	if( ch.freq < INT2FIX(8) ) {	// 無駄処理対策と聞こえない為のチェック(結構効く)
//		return	0;
//	}
