...
//	DEBUGOUT( "CFolderDlg::OnRomBrowse\n" );
	...
	::GetDlgItemText( m_hWnd, IDC_FLD_ROM_EDIT, szFolder, _MAX_PATH );
...
//	DEBUGOUT( "CFolderDlg::OnSaveBrowse\n" );
	CHAR	szFolder[_MAX_PATH];
	::GetDlgItemText( m_hWnd, IDC_FLD_SAVE_EDIT, szFolder, _MAX_PATH );
...
//	DEBUGOUT( "CFolderDlg::OnStateBrowse\n" );
	CHAR	szFolder[_MAX_PATH];
	::GetDlgItemText( m_hWnd, IDC_FLD_STATE_EDIT, szFolder, _MAX_PATH );
...
//	DEBUGOUT( "CFolderDlg::OnSnapshotBrowse\n" );
	CHAR	szFolder[_MAX_PATH];
	::GetDlgItemText( m_hWnd, IDC_FLD_SNAPSHOT_EDIT, szFolder, _MAX_PATH );
...
//	DEBUGOUT( "CFolderDlg::OnMovieBrowse\n" );
	CHAR	szFolder[_MAX_PATH];
	::GetDlgItemText( m_hWnd, IDC_FLD_MOVIE_EDIT, szFolder, _MAX_PATH );
...
//	DEBUGOUT( "CFolderDlg::OnWaveBrowse\n" );
	CHAR	szFolder[_MAX_PATH];
	::GetDlgItemText( m_hWnd, IDC_FLD_WAVE_EDIT, szFolder, _MAX_PATH );
...
//	DEBUGOUT( "CFolderDlg::OnCheatBrowse\n" );
	CHAR	szFolder[_MAX_PATH];
	::GetDlgItemText( m_hWnd, IDC_FLD_CHEAT_EDIT, szFolder, _MAX_PATH );
